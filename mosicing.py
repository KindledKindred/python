...
if __name__ == "__main__":
    ...
    parser.add_argument("inputs", metavar='input', type=str,
                        nargs='+', help='input file')
    parser.add_argument("--output", type=str, default='image_mosicing.png',
                        help='output file (default=image_mosicing.png)')
